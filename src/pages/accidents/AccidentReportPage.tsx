...
import AccidentReportForm from '@/components/accidents/AccidentReportForm';
      ...
      <div className="glass-card rounded-2xl border border-border/80 p-5 sm:p-6 shadow-lg shadow-black/[0.04] space-y-5">
        <div className="text-center space-y-2 pb-1">
          ...
          <div className="flex items-center justify-center gap-2 text-foreground">
            ...
            <h1 className="text-xl font-bold">แจ้งเคสอุบัติเหตุ</h1>
          </div>
          <p className="text-sm text-muted-foreground">
            กรอกรายละเอียดเหตุการณ์ให้ครบถ้วนที่สุดเท่าที่ทราบ — ทีมงานจะตรวจสอบและติดตามต่อ
          </p>
        </div>

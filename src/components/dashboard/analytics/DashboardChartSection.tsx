...
import type { DashboardStatusSlice, DashboardTrendPoint } from '@/lib/dashboard/types';
...
const DashboardChartSection: React.FC<Props> = ({ trendSeries, statusSlices, loading }) => {
